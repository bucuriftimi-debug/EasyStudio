...
EasyStudio Photo and EasyStudio Video are desktop apps. **They do not collect, store or send any personal data to the author.** There are no accounts, no analytics, no advertising and no tracking.

## What stays on your computer

- Your photos, videos, music and projects are opened and edited **only on your computer**. They are never uploaded anywhere by the apps.
- Settings, recent files and the automatic recovery copy of your work are saved in the app's data folder on your computer.

## When the apps use the internet
...
Questions: open an issue at <https://github.com/bucuriftimi-debug/EasyStudio/issues>.
